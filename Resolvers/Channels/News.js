...
/** A class used to fetch/get a {@link https://discord.js.org/docs/packages/discord.js/main/NewsChannel:Class NewsChannel}. */
class ODGNewsChannel {
    constructor(
        /**
         * The client which is used to fetch/get the {@link https://discord.js.org/docs/packages/discord.js/main/NewsChannel:Class NewsChannel}.
    ...
    /**
     * @public
     * The resolver used to resolve a {@link https://discord.js.org/docs/packages/discord.js/main/NewsChannel:Class NewsChannel}.
    ...
    async resolve(resolvable, guild) {
        ...
        if (!(ChannelResolvable instanceof NewsChannel)) return null;
        else return ChannelResolvable;
    }
}

module.exports = ODGNewsChannel;
